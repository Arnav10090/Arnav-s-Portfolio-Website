...
export function DecorativeBackground({ position, className }: DecorativeBackgroundProps) {
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-full h-full max-w-md">
            ...
            <div className="absolute top-1/4 left-1/4 w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 border-[6px] border-blue-600/60 dark:border-blue-400/60 rounded-xl animate-spin-slow shadow-[0_0_30px_rgba(37,99,235,0.3)] backdrop-blur-[2px]"></div>
            
            {/* Pulsing circle - Heavy Purple */}
            <div className="absolute top-1/2 right-1/4 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 border-[6px] border-purple-600/60 dark:border-purple-400/60 rounded-full animate-pulse-slow shadow-[0_0_30px_rgba(147,51,234,0.3)] backdrop-blur-[2px]"></div>
            
            {/* Static triangle - Heavy Indigo */}
            <div className="absolute bottom-1/3 left-1/3 w-0 h-0 border-l-[30px] md:border-l-[35px] lg:border-l-[40px] border-l-transparent border-r-[30px] md:border-r-[35px] lg:border-r-[40px] border-r-transparent border-b-[50px] md:border-b-[60px] lg:border-b-[70px] border-b-indigo-600/50 dark:border-b-indigo-400/50 filter drop-shadow-[0_0_15px_rgba(79,70,229,0.3)]"></div>
          </div>
        </div>
      </div>
    </div>
